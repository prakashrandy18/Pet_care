  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-30 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 hover:shadow-xl group"
      ...
      {/* Mobile-specific message prompt */}
      <AnimatePresence>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                    Hi! 👋 Have questions about our services? We're here to help!
                  </p>
                  <button
                    onClick={handleClick}
